...
Route::get('/gifts', [FrontendController::class, 'gifts'])->name('gifts');
...
//Price Range
Route::get('/price-range/{slug}', [FrontendController::class, 'productPriceRange'])->name('price-range.products');
