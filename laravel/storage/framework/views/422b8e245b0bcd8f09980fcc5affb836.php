...
<?php $__env->startSection('main-content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <a href="<?php echo e(route('post-category.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
    ...
    <div class="table-responsive">
      ...
      data-target="#viewModal<?php echo e($data->id); ?>" style="height:30px; width:30px;border-radius:50%" title="View">
      <i class="fas fa-eye"></i>
      </button>

      <a href="<?php echo e(route('post-category.edit', $data->id)); ?>" class="btn btn-primary btn-sm float-left mr-1"
      style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit"
      data-placement="bottom"><i class="fas fa-edit"></i></a>
      <form method="POST" action="<?php echo e(route('post-category.destroy', [$data->id])); ?>">
      <?php echo csrf_field(); ?>
      <?php echo method_field('delete'); ?>
      <button class="btn btn-danger btn-sm dltBtn" data-id=<?php echo e($data->id); ?>
      ...
      <!-- View Modal -->
      <div class="modal fade" id="viewModal<?php echo e($data->id); ?>" tabindex="-1" role="dialog"
      aria-labelledby="viewModalLabel<?php echo e($data->id); ?>" aria-hidden="true">
      <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      <div class="modal-content">

      <div class="modal-header">
      <h5 class="modal-title">Post Category Details</h5>
      ...
      <p><strong>Slug:</strong> <?php echo e($data->slug); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/postcategory/index.blade.php ENDPATH**/ ?>