				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="#" target="_blank">Benny Cards</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>