									...
									<?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="<?php echo e(route('product-detail', $cart->product['slug'])); ?>"
														target="_blank"><?php echo e($cart->product['title']); ?></a></p>
												<p class="product-des"><?php echo ($cart['summary']); ?></p>
											</td>
											<td class="price" data-title="Price"><span>₹<?php echo e(number_format($cart['price'], 2)); ?></span>
											</td>
											<td class="qty" data-title="Qty"><!-- Input Order -->
												<div class="input-group">
													<div class="button minus">
														<button type="button" class="btn btn-primary btn-number" disabled="disabled"
															data-type="minus" data-field="quant[<?php echo e($key); ?>]">
															<i class="ti-minus"></i>
														</button>
													</div>
													<input type="text" name="quant[<?php echo e($key); ?>]" class="input-number" data-min="1"
														data-max="100" value="<?php echo e($cart->quantity); ?>">
											...
											<td class="total-amount cart_single_price" data-title="Total"><span
													class="money">$<?php echo e($cart['amount']); ?></span></td>

											<td class="action" data-title="Remove"><a href="<?php echo e(route('cart-delete', $cart->id)); ?>"><i
								...
								<?php else: ?>
									<tr>
										<td class="text-center">
											There are no any carts available. <a href="<?php echo e(route('product-grids')); ?>"
								...
								<div class="right">
									<ul>
										...
										<?php if(session()->has('coupon')): ?>
											<li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>">You
												Save<span>₹<?php echo e(number_format(Session::get('coupon')['value'], 2)); ?></span></li>
										<?php endif; ?>
										<?php
										...
										<?php if(session()->has('coupon')): ?>
											<li class="last" id="order_total_price">You
												Pay<span>₹<?php echo e(number_format($total_amount, 2)); ?></span></li>
										<?php else: ?>
											<li class="last" id="order_total_price">You
												Pay<span>₹<?php echo e(number_format($total_amount, 2)); ?></span></li>
										<?php endif; ?>
