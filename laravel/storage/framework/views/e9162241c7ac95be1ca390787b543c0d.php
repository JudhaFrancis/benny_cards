            ...
            <?php $__currentLoopData = $category_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
                    <div class="card category-card">
                        <?php if($cat->photo): ?>
                            <img src="<?php echo e($cat->photo); ?>" class="card-img" alt="<?php echo e($cat->photo); ?>">
                        <?php else: ?>
                            <img src="https://via.placeholder.com/400x400" class="card-img" alt="#">
                        <?php endif; ?>
                        <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-center">
                            <h5 class="card-title text-white font-weight-bold"><?php echo e($cat->title); ?></h5>
                            <a href="<?php echo e(route('product-cat', $cat->slug)); ?>" class="btn btn-success mt-2">Shop Now</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="product-area most-popular section" >
	...
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3890.1234567890!2d77.xxxxxxx!3d8.xxxxxx!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a39…!2s103%20Subash%20Street%2C%20Nagercoil!5e0!3m2!1sen!2sin!4vYYYYYYYYYYYYY!5m2!1sen!2sin" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            ...
            <?php $__currentLoopData = $price_ranges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card price-card">
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-center">
                            <h5 class="card-title text-white font-weight-bold"><?php echo e($price->title); ?></h5>

                            <p class="text-white">Products Starting Price Rs. <?php echo e($price->min_price); ?></p>
                            <a href="<?php echo e(route('price-range.products', $price->slug)); ?>" class="btn btn-success mt-2">Shop Now</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
