              ...
              <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php else: ?>
                      <img src="<?php echo e(asset('backend/img/thumbnail-default.jpg')); ?>" class="img-fluid" style="max-width:80px"
                        alt="avatar.png">
                    <?php endif; ?>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-info btn-sm float-left mr-1" data-toggle="modal"
                      data-target="#viewModal<?php echo e($product->id); ?>" style="height:30px; width:30px;border-radius:50%" title="View">
                      <i class="fas fa-eye"></i>
                    </button>

                    <a href="<?php echo e(route('product.edit', $product->id)); ?>" class="btn btn-primary btn-sm float-left mr-1"
                  ...
                  <!-- View Modal -->
                  <div class="modal fade" id="viewModal<?php echo e($product->id); ?>" tabindex="-1" role="dialog"
                    aria-labelledby="viewModalLabel<?php echo e($product->id); ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <p><strong>Category:</strong> <?php echo e($product->cat_info['title']); ?>

                                <sub><?php echo e($product->sub_cat_info->title ?? ''); ?></sub>
                              </p>
                              <p><strong>Brand:</strong> <?php echo e(ucfirst($product->brand->title ?? 'N/A')); ?></p>
                              <p><strong>Condition:</strong> <?php echo e($product->condition); ?></p>
                              <p><strong>Size:</strong> <?php echo e($product->size); ?></p>
                            </div>
                            <div class="col-md-6">
                              <p><strong>Price:</strong> Rs. <?php echo e($product->price); ?> /-</p>
                              <p><strong>Discount:</strong> <?php echo e($product->discount); ?>% OFF</p>
                              <p><strong>Featured:</strong> <?php echo e(($product->is_featured == 1) ? 'Yes' : 'No'); ?></p>
                              ...
                              <?php if($product->photo): ?>
                                ...
                                <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <img src="<?php echo e(asset($img)); ?>" class="img-fluid mr-2 mb-2" style="max-width:100px"
                                    alt="product image">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php else: ?>
                                <img src="<?php echo e(asset('backend/img/thumbnail-default.jpg')); ?>" class="img-fluid"
                                  style="max-width:100px" alt="avatar.png">
                              <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/product/index.blade.php ENDPATH**/ ?>