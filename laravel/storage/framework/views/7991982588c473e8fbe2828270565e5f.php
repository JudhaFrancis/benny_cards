...
<button type="button" class="btn btn-info btn-sm float-left mr-1"
  data-toggle="modal"
  data-target="#viewModal<?php echo e($post->id); ?>"
  ...
  <i class="fas fa-eye"></i>
                    ...
                    <!-- View Modal -->
<div class="modal fade" id="viewModal<?php echo e($post->id); ?>" tabindex="-1" role="dialog"
  aria-labelledby="viewModalLabel<?php echo e($post->id); ?>" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><strong>Category:</strong> <?php echo e($post->cat_info->title); ?></p>
        ...
        <?php if($post->photo): ?>
          <img src="<?php echo e(asset($post->photo)); ?>" class="img-fluid" style="max-width:300px">
        <?php else: ?>
          <img src="<?php echo e(asset('backend/img/thumbnail-default.jpg')); ?>" class="img-fluid" style="max-width:300px">
        <?php endif; ?>
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/post/index.blade.php ENDPATH**/ ?>