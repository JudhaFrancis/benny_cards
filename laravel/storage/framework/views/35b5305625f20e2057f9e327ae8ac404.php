...
<?php $__env->startSection('main-content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
    ...
    <div class="table-responsive">
      ...
      <td>
      <a href="<?php echo e(route('coupon.edit', $coupon->id)); ?>" class="btn btn-primary btn-sm float-left mr-1"
      style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit"
      data-placement="bottom"><i class="fas fa-edit"></i></a>
      <form method="POST" action="<?php echo e(route('coupon.destroy', [$coupon->id])); ?>">
      <?php echo csrf_field(); ?>
      <?php echo method_field('delete'); ?>
      <button class="btn btn-danger btn-sm dltBtn" data-id=<?php echo e($coupon->id); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/coupon/index.blade.php ENDPATH**/ ?>