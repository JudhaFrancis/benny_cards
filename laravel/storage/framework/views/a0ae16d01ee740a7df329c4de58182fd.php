...
<!-- Price Ranges -->
    ...
    <div id="priceRangeCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('price-range.index')); ?>">Price Range</a>
            <a class="collapse-item" href="<?php echo e(route('price-range.create')); ?>">Add Price Range</a>
        </div>
    </div>
</li>
...
</ul><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>