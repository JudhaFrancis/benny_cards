...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="min_price" type="number" step="0.01" name="min_price" placeholder="Enter minimum price" value="<?php echo e(old('min_price')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
         ...
         <input id="max_price" type="number" step="0.01" name="max_price" placeholder="Enter maximum price" value="<?php echo e(old('max_price')); ?>" class="form-control">
