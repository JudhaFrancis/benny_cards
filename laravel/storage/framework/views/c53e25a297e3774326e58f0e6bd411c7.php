                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-info btn-sm float-left mr-1" data-toggle="modal"
                      data-target="#viewModal<?php echo e($category->id); ?>" style="height:30px; width:30px;border-radius:50%"
                      title="View">
                      <i class="fas fa-eye"></i>
                    </button>

                    <a href="<?php echo e(route('category.edit', $category->id)); ?>" class="btn btn-primary btn-sm float-left mr-1"
                  ...
                  <!-- View Modal -->
                  <div class="modal fade" id="viewModal<?php echo e($category->id); ?>" tabindex="-1" role="dialog"
                    aria-labelledby="viewModalLabel<?php echo e($category->id); ?>" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <p><strong>Title:</strong> <?php echo e($category->title); ?></p>
                          <p><strong>Slug:</strong> <?php echo e($category->slug); ?></p>
                          <p><strong>Is Parent:</strong> <?php echo e($category->is_parent == 1 ? 'Yes' : 'No'); ?></p>
                          <p><strong>Parent Category:</strong> <?php echo e($category->parent_info->title ?? 'N/A'); ?></p>
                          ...
                          <?php if($category->photo): ?>
                            <img src="<?php echo e(asset($category->photo)); ?>" class="img-fluid" style="max-width:150px"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\benny_cards\laravel\resources\views/backend/category/index.blade.php ENDPATH**/ ?>