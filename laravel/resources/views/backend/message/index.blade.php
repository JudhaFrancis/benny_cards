    ...
    <table class="table message-table" id="message-dataTable">
      ...
      <tbody>
        ...
        <tr class="@if($message->read_at) border-left-success @else bg-light border-left-warning @endif">
          ...
          <td>
            <a href="{{route('message.show',$message->id)}}" class="btn btn-edit btn-sm mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
