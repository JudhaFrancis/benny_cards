                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-info btn-sm float-left mr-1" data-toggle="modal"
                      data-target="#viewModal{{$product->id}}" style="height:30px; width:30px;border-radius:50%" title="View">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <p><strong>Featured:</strong> {{($product->is_featured == 1) ? 'Yes' : 'No'}}</p>
                              ...
                              @if($product->photo)
                                ...
                                @foreach($photos as $img)
                                  <img src="{{ asset($img) }}" class="img-fluid mr-2 mb-2" style="max-width:100px"
                                    alt="product image">
                                @endforeach
                              @else
