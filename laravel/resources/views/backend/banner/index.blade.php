...
@section('main-content')
  ...
  <div class="card shadow mb-4">
    ...
    <tr>
      ...
      data-target="#viewModal{{$banner->id}}" style="height:30px; width:30px;border-radius:50%" title="View">
      ...
      @if($banner->photo)
      <img src="{{($banner->photo) }}" class="img-fluid" alt="{{ $banner->title }}">
      @else
      <img src="{{ asset('backend/img/thumbnail-default.jpg') }}" class="img-fluid" alt="default">
      @endif
      </div>
