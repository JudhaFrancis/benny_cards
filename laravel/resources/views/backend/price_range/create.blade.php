    ...
    <div class="card-body">
      <form method="post" action="{{route('price-range.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="min_price" type="number" step="0.01" name="min_price" placeholder="Enter minimum price" value="{{old('min_price')}}" class="form-control">
        ...
        <div class="form-group">
         ...
         <input id="max_price" type="number" step="0.01" name="max_price" placeholder="Enter maximum price" value="{{old('max_price')}}" class="form-control">
