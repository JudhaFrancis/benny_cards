...
@section('title', 'BENNY CARDS || Brand Page')
@section('main-content')
  ...
  <div class="card my-4">
    ...
    <h3 class="m-0 font-weight-bold text-primary float-left">Brand List</h3>
    ...
    <div class="table-responsive">
      ...
      data-target="#viewModal{{$brand->id}}" style="height:30px; width:30px; border-radius:50%" title="View">
      <i class="fas fa-eye"></i>
      </button>
      <a href="{{route('brand.edit', $brand->id)}}" class="btn btn-primary btn-sm mr-1"
      style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit"
      data-placement="bottom"><i class="fas fa-edit"></i></a>
      <form method="POST" action="{{route('brand.destroy', [$brand->id])}}" style="display:inline-block;">
      @csrf
      @method('delete')
      ...
      <!-- View Modal -->
      <div class="modal fade" id="viewModal{{$brand->id}}" tabindex="-1" role="dialog"
      aria-labelledby="viewModalLabel{{$brand->id}}" aria-hidden="true">
