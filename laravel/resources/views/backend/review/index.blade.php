...
@section('main-content')
  ...
  <div class="card my-4">
    ...
    <div class="table-responsive">
      ...
      @for($i = 1; $i <= 5; $i++)
      @if($review->rate >= $i)
      <li style="float:left;color:#ec1176;"><i class="fa fa-star"></i></li>
      @else
      <li style="float:left;color:#ec1176;"><i class="far fa-star"></i></li>
      @endif
      @endfor
      </ul>
      </td>
      ...
      <td>
      <a href="{{route('review.edit', $review->id)}}" class="btn btn-primary btn-sm mr-1"
