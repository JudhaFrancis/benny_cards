...
<div class="card">
    <h5 class="card-header">Edit Invitation</h5>
    <div class="card-body">
        <form method="post" action="{{route('invitation_cards.update',$product->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                ...
                <select name="condition" class="form-control">
                    ...
                    <option value="trending" {{ ($product->condition == 'trending') ? 'selected' : '' }}>Trending
                    </option>
