...
@section('main-content')
  ...
  <div class="card my-4">
    ...
    <h3 class="m-0 font-weight-bold text-primary float-left">Shipping List</h3>
    ...
    <div class="table-responsive">
      ...
      data-target="#viewModal{{$shipping->id}}" style="height:30px; width:30px;border-radius:50%"
      title="View">
      ...
      <!-- View Modal -->
      <div class="modal fade" id="viewModal{{$shipping->id}}" tabindex="-1" role="dialog"
      aria-labelledby="viewModalLabel{{$shipping->id}}" aria-hidden="true">
      ...
      <p><strong>Title:</strong> {{ $shipping->type }}</p>
      <p><strong>Price:</strong> ${{ $shipping->price }}</p>
