          ...
          <tbody>
            @foreach($users as $user)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('users.edit',$user->id)}}" class="btn btn-edit btn-sm mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-pen"></i></a>
