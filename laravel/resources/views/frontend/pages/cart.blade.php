...
<div class="shopping-cart section">
                ...
                <form action="{{route('cart.update')}}" method="POST">
                    ...
                    <div class="cart-card-sm mb-3 p-3 rounded d-flex align-items-center justify-content-between">
                        ...
                        <div class="cart-img me-3 flex-shrink-0">
                            <img src="{{$photo[0]}}" class="img-fluid rounded" alt="{{$cart->product['title']}}"
    ...
    Stock: {{$cart->product['stock']}}
                        ...
                        <div class="input-group quantity-wrapper">
                            ...
                            <!-- Quantity Input -->
                            <input type="text" name="quant[{{$key}}]" class="input-number text-center" data-min="1"
                                data-max="100000" value="{{$cart->quantity}}">

                            <!-- Plus Button -->
                            <button type="button" class="btn-number plus" data-type="plus" data-field="quant[{{$key}}]">
                                <i class="ti-plus"></i>
                            </button>
                        ...
                        <div class="cart-remove text-center flex-shrink-0">
                            <a href="{{route('cart-delete',$cart->id)}}" class="text-danger fs-5"><i class="ti-trash"
                                    style="font-size: 20px;"></i></a>
                        </div>
                    </div>
                    <div class="cart-divider d-none d-md-block"></div>
                ...
                <div class="card-sm p-3 sticky-top price-card" style="z-index:1;">
                    ...
                    <div class="coupon-section mb-3">
                        <form action="{{route('coupon-store')}}" method="POST" class="d-flex">
                            @csrf
                            <input type="text" name="code" class="form-control me-2 px-3"
