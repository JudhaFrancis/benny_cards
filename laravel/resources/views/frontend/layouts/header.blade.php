            ...
            <div class="cat-nav-head">
                <div class="row align-items-center" style="text-align-last: center;">
                    ...
                    <div class="search-bar search-wrapper col-7 col-lg-3">
                        @csrf
                        <input id="searchInput" name="search" type="search" autocomplete="off" style="padding-left:12px;outline:none">
                        <span id="fakePlaceholder" class="fake-placeholder"></span>
                        <button class="btnn" type="submit"><i class="ti-search"></i></button>
                        <ul id="suggestions" style="display:none;position:absolute;top:100%;left:0;right:0;background:#fff;border:1px solid #ccc;list-style:none;border-radius:8px;margin:3px 0;padding:10px 0;z-index:999;"></ul>
                    </div>
                    <nav class="navbar d-block d-sm-none col-2">
                        ...
                        <div class="nav-inner" id="mainMenu">
                            <ul class="nav main-menu menu navbar-nav">
                                ...
                                @endif
                                <li class="icon-space"><i class="ti-power-off"></i><a href="{{route('user.logout')}}">Logout</a></li>
                                @else
